...
export async function saveCategory(
  ...
  if (id) await db.productCategory.update({ where: { id }, data });
  else await db.productCategory.create({ data });
...
export async function saveCrop(
  ...
  if (id) await db.crop.update({ where: { id }, data });
  else await db.crop.create({ data });
