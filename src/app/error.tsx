...
export default function GlobalError({
  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center bg-paper px-6 text-center">
      ...
      <h1 className="mt-6 text-display-3 text-ink">Something went wrong</h1>
      <p className="mt-3 max-w-md text-ink-soft">
        The page hit an unexpected problem. It’s usually temporary — try again, or head back to safe
        ground.
      </p>
