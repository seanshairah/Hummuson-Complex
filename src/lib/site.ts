...
export const site = {
  ...
  description:
    "Humuson Complex supplies modern agricultural technology — microbiological fertilisers, biostimulants and liquid foliar fertilisers — with agronomic support across Zimbabwe and Southern Africa.",
  url: resolveSiteUrl(),
